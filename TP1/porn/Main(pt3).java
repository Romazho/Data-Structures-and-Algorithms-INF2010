...
class Item{
	...
	public void print() {
		System.out.println(this.nombre_); 
	}
}
...
public class Main { 
	...
	System.out.println("Le prermier objet de pile: " + pile.getFirstElement().getNombre());
	System.out.println("Le prermier objet de file: " + file.getFirstElement().getNombre());
	System.out.println("Le prermier objet de sac: " + sac.getIndex(0).getNombre());
